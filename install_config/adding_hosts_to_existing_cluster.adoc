...
.. Add a xref:../install_config/adding_hosts_to_existing_cluster.adoc#adding-hosts_adding-hosts-to-cluster[master]. In step 3 of that process, add the
...
. To add the new node, xref:../install_config/adding_hosts_to_existing_cluster.adoc#adding-hosts_adding-hosts-to-cluster[scale up the infrastructure].
