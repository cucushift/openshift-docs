...
include::day_two_guide/topics/con_scaling-etcd.adoc[leveloffset=+3]
include::day_two_guide/topics/proc_scaling-etcd-ansible.adoc[leveloffset=+4]
include::day_two_guide/topics/proc_scaling-etcd-manual.adoc[leveloffset=+4]
include::day_two_guide/topics/proc_removing-etcd-host.adoc[leveloffset=+3]
